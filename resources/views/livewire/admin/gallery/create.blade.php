<div class="space-y-6">
    <div class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <h1 class="mt-2 text-3xl font-semibold text-zinc-950 dark:text-white">Tambah Album Galeri</h1>
        <p class="mt-2 max-w-3xl text-sm leading-7 text-zinc-600 dark:text-zinc-300">
            Buat album baru dan isi beberapa gambar sekaligus untuk dokumentasi pesantren.
        </p>
    </div>
